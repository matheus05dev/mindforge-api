...
public class KnowledgeBaseController {
    ...
    public ResponseEntity<KnowledgeItemResponse> createItem(@RequestBody KnowledgeItemRequest request) {
        ...
        KnowledgeItem createdItem = service.createItem(item);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<KnowledgeItemResponse> updateItem(@PathVariable Long id, @RequestBody KnowledgeItemRequest request) {
        KnowledgeItem item = mapper.toEntity(request);
