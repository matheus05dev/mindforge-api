...
public class PromptBuilderService {
    ...
    private String buildBaseSystemPrompt(UserProfileAI userProfile, Optional<Subject> subject,
    ...
    public PromptPair buildGenericPrompt(String question, UserProfileAI profile, Optional<Subject> subject,
            Optional<Project> project) {
    ...
    // Manter os outros métodos simplificados por enquanto, para focar na correção
    // principal.
